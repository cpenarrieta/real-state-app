...
export default function DeleteAccountModal({ showModal, setShowModal }) {
  const { setShowAlert } = useAlert();
  const [deleteAccount, { error }] = useMutation(DELETE_ACCOUNT_MUTATION);
              ...
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    ...
                    <p className="text-sm leading-5 text-gray-500">
                      All your properties, images and attachments will be
                      deleted too.
                    </p>
                  </div>
                </div>
