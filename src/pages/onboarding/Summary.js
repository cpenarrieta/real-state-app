    ...
    <div className="bg-white">
      <div className="max-w-screen-xl mx-auto text-center py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <h2 className="text-3xl leading-9 font-extrabold tracking-tight text-logoFont sm:text-4xl sm:leading-10">
          You are ready to create your first Property!{" "}
        ...
        <div className="mt-8 flex justify-center">
          ...
          <div className="ml-3 inline-flex">
            <button
              ...
              className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-logoFont bg-logoPink hover:text-gray-900 hover:bg-logoPinkfocus:outline-none focus:shadow-outline focus:border-logoPink transition duration-150 ease-in-out"
            >
              Go to Dashboard
            </button>
          </div>
